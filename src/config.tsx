...
interface NavExtraBase {
  ...
  system: string;
  /**
   * Аль дэд бүлэг. Байгаа бүлгийн `labelKey`-тэй таарвал түүн рүү нэмнэ,
   * эс бөгөөс тэр нэрээр ШИНЭ бүлэг эхэнд үүснэ.
   *
   * Дундын толийн түлхүүр (`DictKey`) байх шаардлагагүй — платформын өөрийн
   * бүлэг (`group.workflow` г.м.) байж болно. Тийм үед нэрийг
   * `subsystemLabel`-ээр өгнө, эс бөгөөс түлхүүр өөрөө харагдана.
   */
  subsystem: string;
  /** Шинэ дэд бүлгийн нэрийг аппын толиос авах. */
